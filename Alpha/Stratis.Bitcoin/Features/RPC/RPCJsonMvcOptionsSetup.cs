...
namespace Stratis.Bitcoin.Features.RPC
{
    public class RPCJsonMvcOptionsSetup : ConfigureOptions<MvcOptions>
	{
		...
		public RPCJsonMvcOptionsSetup(ILoggerFactory loggerFactory, IOptions<MvcJsonOptions> jsonOptions, ArrayPool<char> charPool, ObjectPoolProvider objectPoolProvider) : base(delegate(MvcOptions options)
		{
