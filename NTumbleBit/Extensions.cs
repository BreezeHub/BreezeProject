...
namespace NTumbleBit
{
    public static class Extensions
    {
        ...
        public static RPCResponse SendCommandNoThrows(this RPCClient client, string commandName,
        ...
        public static Task<RPCResponse> SendCommandNoThrowsAsync(this RPCClient client, string commandName,
            params object[] parameters)
        {
        ...
        public static ScriptCoin Clone(this ScriptCoin scriptCoin, Network network)
        {
            return ScriptCoin.Create(network, scriptCoin, scriptCoin.Redeem);
        }
    }
}