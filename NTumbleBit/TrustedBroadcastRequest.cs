...
namespace NTumbleBit
{
    public class TrustedBroadcastRequest
    {
        ...
        public Script PreviousScriptPubKey { get; set; }
        public OutPoint SignedOutpoint { get; set; }

        public WitScript Signature { get; set; }
        public Transaction Transaction { get; set; }
        public Key Key { get; set; }
        public LockTime BroadcastAt { get; set; }
        ...
        public Coin[] KnownPrevious { get; set; }

        public Transaction ReSign(Coin coin, Network network)
        {
            return ReSign(coin, network, out bool a);
        }

        public Transaction ReSign(Coin coin, Network network, out bool cached)
        {
            ...
            byte[] signature = transaction.SignInput(network, Key, scriptCoin).ToBytes();
