...
namespace NTumbleBit.PuzzlePromise
{
    ...
    public class PromiseServerSession : EscrowInitiator
    {
        public class EncryptedSignature
        {
            ...
            public uint256 SignedHash { get; set; }
        ...
        {
            public EncryptedSignature[] EncryptedSignatures { get; set; }

            public PromiseServerStates Status { get; set; }
            public uint256 FakeIndexesHash { get; set; }
