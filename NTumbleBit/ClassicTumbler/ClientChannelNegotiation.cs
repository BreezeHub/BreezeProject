...
namespace NTumbleBit.ClassicTumbler
{
    ...
    public class ClientChannelNegotiation
    {
        public class State
        {
            ...
            public TumblerClientSessionStates Status { get; set; }

            public int CycleStart { get; set; }

            public byte[] SignedVoucher { get; set; }
            public UnsignedVoucherInformation UnsignedVoucher { get; set; }
            public PuzzleValue BlindedVoucher { get; set; }
            public BlindFactor BlindedVoucherFactor { get; set; }

            public Script TumblerEscrow { get; set; }
            public Script ClientEscrow { get; set; }
            public Key TumblerEscrowKey { get; set; }
            public Key ClientEscrowKey { get; set; }
            public int TumblerEscrowKeyReference { get; set; }
        ...
        public ClassicTumblerParameters Parameters { get; private set; }
        ...
        public TxOut BuildClientEscrowTxOut()
        {
            ...
            return new TxOut(Parameters.Denomination + Parameters.Fee,
                InternalState.ClientEscrow.WitHash.ScriptPubKey.Hash);
        }
        ...
        public void CheckVoucherSolution(PuzzleSolution blindedVoucherSignature)
        {
            ...
            var solution =
                blindedVoucherSignature.Unblind(Parameters.VoucherKey.PublicKey, InternalState.BlindedVoucherFactor);
