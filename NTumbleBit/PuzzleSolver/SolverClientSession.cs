...
namespace NTumbleBit.PuzzleSolver
{
    ...
    public class SolverClientSession : EscrowInitiator
    {
        ...
        public SolverClientSession(SolverParameters parameters, Network network)
        {
        ...
        public SolverClientSession(SolverParameters parameters, State state, Network network) : this(parameters,
            network)
        {
            if (state == null)
                return;
        ...
        public new class State : EscrowInitiator.State
        {
            ...
            public SolverClientStates Status { get; set; }
            public PuzzleSolution PuzzleSolution { get; set; }
            public PuzzleValue[] Puzzles { get; set; }
            public ServerCommitment[] Commitments { get; set; }
            public int[] FakeIndexes { get; set; }
            public PuzzleSolution[] FakeSolutions { get; set; }
            public BlindFactor[] BlindFactors { get; set; }
        ...
        {
            get { return _Parameters.ServerKey; }
        }
        ...
        public TransactionSignature SignOffer(OfferInformation offerInformation)
        {
            ...
            escrowCoin = escrowCoin.Clone(_network);
            escrowCoin.OverrideScriptCode(escrow.GetInitiatorScriptCode());
            var signature = tx.Inputs.AsIndexedInputs().First()
                .Sign(_network, InternalState.EscrowKey, escrowCoin, SigHash.All);
        ...
        public TransactionSignature SignEscape()
        {
            ...
            return dummy.SignInput(_network, InternalState.EscrowKey, coin, SigHash.None | SigHash.AnyoneCanPay);
        }
